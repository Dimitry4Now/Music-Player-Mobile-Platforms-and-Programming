package com.example.musicplayerby175030.Activity;
...
import com.example.musicplayerby175030.Adapter.ViewPageAdapter;
import com.example.musicplayerby175030.DB.FavoritesOperations;
...
import com.example.musicplayerby175030.Model.SongsList;
import com.example.musicplayerby175030.R;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, AllSongFragment.createDataParse, FavSongFragment.createDataParsed, CurrentSongFragment.createDataParsed {
    ...
    private void init() {
        ImageButton imgBtnPrev = findViewById(R.id.img_btn_previous);
        imgBtnNext = findViewById(R.id.img_btn_next);
        ImageButton imgbtnReplay = findViewById(R.id.img_btn_replay);
    ...
    //Baranje permisija od korisnikot
   ...
   //Dopolnitelni postavki za tab layout zaedno so ViewPager

    private void setPagerLayout() {
        ViewPageAdapter adapter = new ViewPageAdapter(getSupportFragmentManager(), getContentResolver());
    ...
    //Funkcija za prikazhuvanje na dialogot About(Za aplikacijata)
    private void about() {
    ...
    //Podesuvanje na menito(Action Bar)
    ...
    //Funkcija za spravuvanje so klikovi
    ...
    //Funkcija za dodavanje na pesni na pleerot
    ...
    //Funkcija za postavuvanje na kontrolite vo zavisnost od pesnata
    ...
    //Funkcija za pushtanje pesna so pomosh na poseben Thread
    ...
    private String getTimeFormatted(long milliSeconds) {
        ...
        //Pretvaranje na traenjeto na pesnata vo vreme
        int hours = (int) (milliSeconds / 3600000);
        int minutes = (int) (milliSeconds % 3600000) / 60000;
        int seconds = (int) ((milliSeconds % 3600000) % 60000 / 1000);

        // Dodavanje na chasovi
        if (hours > 0)
            finalTimerString = hours + ":";

        // Dodavanje na nula pred sekundite se dodeka se ednocifren broj
        if (seconds < 10)
        ...
        //Vrati go sredeniot string
        return finalTimerString;
    }

    //Ovveride na finciite za dobivanje podatoci od fragmentite
